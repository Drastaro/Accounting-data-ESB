	...
	<table class="table table-striped table-hover table-bordered" style="text-align:right" id="table_cheltuieli" >
		...
		<tbody>
			...
			<tr class="isChildRow hide">
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['CHELTUIELI_MATERIALE']->valueCumulated()}</span></td>
					<td>{$rap['CHELTUIELI_MATERIALE']->valueCumulatedPercent()}%</td>
					{/foreach}
			</tr>
			...
			<tr class="isChildRow hide">
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['CHELTUIELI_CU_SERVICII_PRESTATE_DE_TERTI']->valueCumulated()}</span></td>
					<td>{$rap['CHELTUIELI_CU_SERVICII_PRESTATE_DE_TERTI']->valueCumulatedPercent()}%</td>
					{/foreach}
			</tr>
			...
			<!-- ALTE cheltuieli de exploatare -->
				<tr>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['ALTE_CHELTUIELI_DE_EXPLOATARE']->valueCumulated()}</span></td>
					<td>{$rap['ALTE_CHELTUIELI_DE_EXPLOATARE']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
				...
				<tr>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['TOTAL_CHELTUIELI_DE_EXPLOATARE']->valueCumulated()}</span></td>
					<td>{$rap['TOTAL_CHELTUIELI_DE_EXPLOATARE']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
			...
			<!-- Cheltuieli Financiare -->
				<tr>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['CHELTUIELI_FINANCIARE']->valueCumulated()}</span></td>
					<td>{$rap['CHELTUIELI_FINANCIARE']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
			...
			<!-- END Cheltuieli financiare-->
				<tr>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['CHELTUIELI_EXTRAORDINARE']->valueCumulated()}</span></td>
					<td>{$rap['CHELTUIELI_EXTRAORDINARE']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
				<tr>
					<td style="text-align:center;"></td>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['CHELTUIELI_TOTALE_INAINTE_IMPOZITARE']->valueCumulated()}</span></td>
					<td>{$rap['CHELTUIELI_TOTALE_INAINTE_IMPOZITARE']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
				<tr>
					<td style="text-align:center;"></td>
					...
					{foreach from=$rapoarteBalante item=rap}
					<td><span class="money">{$rap['IMPOZIT_PE_PROFIT']->valueCumulated()}</span></td>
					<td>{$rap['IMPOZIT_PE_PROFIT']->valueCumulatedPercent()}%</td>
					{/foreach}
				</tr>
				<tr>
					<td style="text-align:center;"></td>
