	...
	<div class="portlet-body">
		...
		<table class="table table-striped table-hover table-bordered" style="text-align:right" id="table_venituri" >
			...
			<tr>
				...
				<td><span class="money">{$rap['CIFRA_DE_AFACERI']->valueCumulated()}</span></td>
				<td>{$rap['CIFRA_DE_AFACERI']->valueCumulatedPercent()}%</td>
				{/foreach}
			</tr>
			...
			<tr>
				...
				{foreach from=$rapoarteBalante item=rap}
				<td><span class="money">{$rap['ALTE_VENITURI_DIN_EXPLOATARE']->valueCumulated()}</span></td>
				<td>{$rap['ALTE_VENITURI_DIN_EXPLOATARE']->valueCumulatedPercent()}%</td>
				{/foreach}
			</tr>
			...
			<tr>
				...
				{foreach from=$rapoarteBalante item=rap}
				<td><span class="money">{$rap['TOTAL_VENITURI_DIN_EXPLOATARE']->valueCumulated()}</span></td>
				<td>{$rap['TOTAL_VENITURI_DIN_EXPLOATARE']->valueCumulatedPercent()}%</td>
				{/foreach}
			</tr>
			<tr>
				<td style="width: 10px; text-align:center;" class="details-control"><i class="fa fa-plus-square-o fa-lg"></i></td>
				...
				{foreach from=$rapoarteBalante item=rap}
				<td><span class="money">{$rap['VENITURI_FINANCIARE']->valueCumulated()}</span></td>
				<td>{$rap['VENITURI_FINANCIARE']->valueCumulatedPercent()}%</td>
				{/foreach}
			</tr>
			...
			<tr>
				...
				{foreach from=$rapoarteBalante item=rap}
				<td><span class="money">{$rap['VENITURI_EXTRAORDINARE']->valueCumulated()}</span></td>
				<td>{$rap['VENITURI_EXTRAORDINARE']->valueCumulatedPercent()}%</td>
				{/foreach}
			</tr>
			<tr>
				<td style="text-align:center;"></td>
