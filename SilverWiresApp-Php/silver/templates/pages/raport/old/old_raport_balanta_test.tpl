...
var TabeleRaportLunar = function() {
   ...
   return {
        ...
        init: function () {
           ...
           TabeleRaportLunar.initTableVenituri();
            
            
        },

		initTableVenituri: function () {  

var table=$('#table_cpp').DataTable({"paging":false, "ordering":false, "searching":false, "info":false});  	
     
	 // Add event listener for opening and closing details on FIRST level
    $('#table_cpp tbody').on('click', 'td.details-control', function () {	
	
		if($(this).children(".row-details").hasClass("row-details-close")) {
			//open the row marker
			$(this).children(".row-details").removeClass("row-details-close");
			$(this).children(".row-details").addClass("row-details-open");
		} else {
			//close the row marker
			$(this).children(".row-details").removeClass("row-details-open");
			$(this).children(".row-details").addClass("row-details-close");
		}
		...
		while(nextTr.hasClass('isChildRow') || nextTr.hasClass('isSubChildRow')) {
			if(nextTr.hasClass('isChildRow')) {
				...
				if(nextTr.hasClass('hide')) {
					...
					if(nextTr.find('span').hasClass("row-details-open")) {
						nextTr.find('span').removeClass("row-details-open");
						nextTr.find('span').addClass("row-details-close");
    ...
    $('#table_cpp tbody').on('click', 'td.sub-details-control', function () {	
		if($(this).children(".row-details").hasClass("row-details-close")) {
			//open the row marker
			$(this).children(".row-details").removeClass("row-details-close");
			$(this).children(".row-details").addClass("row-details-open");
