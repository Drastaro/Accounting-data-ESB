...
public class CreditNote {
    ...
    public List<JAXBElement<List<String>>> getLineAmountTypes() {
        if (lineAmountTypes == null) {
            lineAmountTypes = new ArrayList<JAXBElement<List<String>>>();
        }
     ...
     *     
     */
    public void setSubTotal(JAXBElement<BigDecimal> value) {
        this.subTotal = value;
    }
     ...
     *     
     */
    public void setTotalTax(JAXBElement<BigDecimal> value) {
        this.totalTax = value;
    }
